...
try {
    ...
    insertOrder.run('table_1', 1, 2, pastTime1); // 2 beers
    insertOrder.run('table_1', 4, 1, pastTime1); // 1 edamame
    insertOrder.run('table_2', 2, 3, pastTime2); // 3 highballs
    insertOrder.run('table_2', 7, 2, pastTime2); // 2 karaage
